package com.app.common.containers;
...
public class ObjectReturn {
    ...
    public static ObjectReturn Fail(Class<?> aClass) {
        return ObjectReturn.Fail(INVALID_OBJECT_OF_TYPE, aClass);
    }

    public static ObjectReturn Fail(String message) {
        return ObjectReturn.Fail(message, (Object) null);
    }

    public static ObjectReturn Fail(String format, Object... args) {
        return ObjectReturn.type(Type.Fail, format, args);
    }

    public static ObjectReturn NotImplemented() {
        return ObjectReturn.NotImplemented((String) null);
    }

    public static ObjectReturn NotImplemented(Class<?> aClass) {
        return ObjectReturn.NotImplemented(INVALID_OBJECT_OF_TYPE, aClass);
    }

    public static ObjectReturn NotImplemented(String message) {
        return ObjectReturn.NotImplemented(message, (Object) null);
    }

    public static ObjectReturn NotImplemented(String format, Object... args) {
        return ObjectReturn.type(Type.NotImplemented, format, args);
    }

    public static ObjectReturn type(Type type) {
        return ObjectReturn.type(type, (String) null);
    }

    public static ObjectReturn type(Type type, Class<?> aClass) {
        return ObjectReturn.type(type, aClass == null ? "" : aClass.toString());
    }

    public static ObjectReturn type(Type type, String message) {
        return ObjectReturn.type(type, message, (Object) null);
    }
    ...
    public static class MessageMaker {
        ...
        public ObjectReturn end() {
            ...
            this.objectReturn.internalMessages
                    .add(
                            Message
                                    .builder()
                                    .type(this.type)
