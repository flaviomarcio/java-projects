...
public class PrimitiveUtil {
    ...
    public static boolean inRange(final LocalDate value, final LocalDate begin, final LocalDate end) {
        if (rangeIsNull(value, begin, end))
            return false;
    ...
    private static boolean rangeIsNull(LocalDate value, LocalDate begin, LocalDate end) {
        return ((value == null) || (begin == null && end == null));
    }
    private static boolean rangeIsNull(LocalDateTime value, LocalDateTime begin, LocalDateTime end) {
        return ((value == null) || (begin == null && end == null));
    }
    private static boolean rangeIsNull(LocalTime value, LocalTime begin, LocalTime end) {
        return ((value == null) || (begin == null && end == null));
    }
